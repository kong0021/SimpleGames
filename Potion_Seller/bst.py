...
class BinarySearchTree(Generic[K, I]):
    ...
    def get_successor(self, current: TreeNode) -> TreeNode:
        ...
        # Process:
        # One step to the right, then all
        # steps to the left until you find a leaf
    ...
    def get_predecessor(self, current: TreeNode) -> TreeNode:
        ...
        # Process:
        # One step to the left, then all
        # steps to the right until you find a leaf
...
# print(b.get_minimal(b.get_tree_node_by_key(15)))
...
# print(b.get_minimal(b.get_tree_node_by_key(64)))
...
# print(b.get_successor(b.get_tree_node_by_key(15)))
...
# print(b.get_successor(b.get_tree_node_by_key(64)))
...
# print(b.get_successor(b.get_tree_node_by_key(43)))
